...
import { useCreateStatusAPIMutation } from "../../services/datacommunication";
...
export default function Registration() {
 ...
 const [serverstatus,setServerstatus] = useState({status:"",doctor:""})
  ...
  const [createStatus, {isLoading}] = useCreateStatusAPIMutation();
...
console.log(data);
  ...
  return (
    ...
    //         <input type="number" name="user_id" id="user_id"  className="border-2 rounded-lg mt-2 h-8 w-80" placeholder={users[0].id} onChange={handleChangepatient}/>
